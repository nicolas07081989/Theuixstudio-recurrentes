...
class Environment
{
    ...
    public static function recurring_config(): array
    {
        ...
        return [
            ...
            'eci' => Settings::get($mode === 'test' ? 'recurring_eci_test' : 'recurring_eci_prod', '0103910'),
            'pserv' => Settings::get($mode === 'test' ? 'recurring_pserv_test' : 'recurring_pserv_prod', '17913101'),
            'versiondf' => '2',
